class Grade3Controller < ApplicationController
  add_breadcrumb 'Home', '/'
  ...
  def tangen
    ...
    add_breadcrumb '中学3年生', '/grade3/index'
    add_breadcrumb @grade_unit_item_name

    @grade_lessons = Lesson.where(["unit_item_name = ? and grade = ?", @grade_unit_item_name, 3]).select('id, title, summary, exercise, point')
  ...
  def show
    ...
    add_breadcrumb '中学3年生', '/grade3/index'
    add_breadcrumb @grade_unit_item_name,'/grade3/'+@grade_unit_item_name
